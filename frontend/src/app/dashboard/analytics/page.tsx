...
const metrics = [
  { label: 'Impressions', value: '425.2k', change: '+18.4%', icon: Eye, color: 'text-primary-500' },
  { label: 'Engagement Rate', value: '3.82%', change: '+2.1%', icon: TrendingUp, color: 'text-black' },
  { label: 'Link Clicks', value: '8,420', change: '+12.5%', icon: MousePointer2, color: 'text-primary-600' },
          ...
          <div className="h-64 flex items-end justify-between gap-2">
             ...
             {Array.from({ length: 12 }).map((_, i) => (
               <div key={i} className="flex-1 space-y-2">
                 <div
                   className="w-full bg-primary-500/40 hover:bg-primary-500 transition-all rounded-t-lg"
