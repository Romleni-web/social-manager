    ...
    <div className="min-h-screen bg-white flex items-center justify-center p-6">
      <div className="w-full max-w-md space-y-8">
        <div className="text-center">
          ...
          <h1 className="text-3xl font-black tracking-tight uppercase italic">Create Account</h1>
          <p className="text-slate-500 mt-2 font-bold uppercase text-[10px] tracking-widest">Join SocialAI and start scaling today.</p>
        </div>
        ...
        <p className="text-center text-[10px] text-slate-500 font-black uppercase tracking-widest">
          ...
          <Link href="/login" className="text-primary-600 font-black hover:text-primary-700 border-b-2 border-primary-500/20">Login here</Link>
        </p>
      </div>
    </div>
  );
