    ...
    <div className="min-h-screen bg-[#020617] text-slate-100 selection:bg-primary-500/30">
      ...
      <nav className="flex items-center justify-between p-6 max-w-7xl mx-auto">
        ...
        <div className="flex items-center gap-8">
          ...
          <Link href="/register" className="px-6 py-2.5 bg-primary-600 hover:bg-primary-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-primary-600/20">
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-6 pt-20 pb-32 text-center">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary-600/10 border border-primary-600/20 text-primary-400 text-xs font-bold uppercase tracking-widest mb-8">
          <Zap className="w-4 h-4" />
          Now with GPT-4 Turbo Integration
        </div>
        <h1 className="text-6xl md:text-8xl font-black tracking-tighter mb-8 leading-[0.9]">
          SCALE YOUR <span className="text-primary-500">SOCIAL</span> <br />
          WITH PURE <span className="text-slate-500">AI POWER.</span>
        </h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-4">
          <Link href="/dashboard" className="w-full md:w-auto px-10 py-5 bg-white text-black font-black text-lg rounded-2xl hover:bg-slate-200 transition-all flex items-center justify-center gap-2 group">
            Go to Dashboard
            <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
          </Link>
          <Link href="/admin" className="w-full md:w-auto px-10 py-5 bg-white/5 border border-white/10 text-white font-black text-lg rounded-2xl hover:bg-white/10 transition-all">
            Admin Demo
          </Link>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-32">
          <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 text-left hover:border-primary-500/50 transition-all">
            <div className="w-12 h-12 bg-primary-600/20 rounded-2xl flex items-center justify-center mb-6">
      ...
      {/* Footer */}
      <footer className="border-t border-white/5 py-12 text-center text-slate-600 text-sm font-bold uppercase tracking-widest">
